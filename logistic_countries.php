<?php
	 ...
	 */
	class plgVmShipmentLogistic_countries extends vmPSPlugin
	{
		function __construct ( &$subject, $config )
		{
			...
			$this->setConvertable(array('min_amount','max_amount','shipment_cost'));
		}
		/**
		...
		public function getVmPluginCreateTableSQL () {
			...
			return $this->createTableSQL ('Shipment Logistic Countries Table');
		}
